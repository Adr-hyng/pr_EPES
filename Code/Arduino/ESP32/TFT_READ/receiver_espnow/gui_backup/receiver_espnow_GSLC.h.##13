...
enum {E_SEVEN_SEGMENT18,E_SEVEN_SEGMENT22,E_SEVEN_SEGMENT30
      ,E_SEVEN_SEGMENT8,MAX_FONT};
//<Enum !End!>
...
//<InitGUI !Start!>
  ...
  // Create CurTemperature text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,CurTemperature,E_PG_MAIN,(gslc_tsRect){135,15,37,30},
    (char*)"75",0,E_SEVEN_SEGMENT22);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  
  // Create E_ELEM_TEXT4 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT4,E_PG_MAIN,(gslc_tsRect){178,10,20,10},
    (char*)"O",0,E_SEVEN_SEGMENT8);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  
  // Create E_ELEM_TEXT5 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT5,E_PG_MAIN,(gslc_tsRect){193,15,15,30},
    (char*)"c",0,E_SEVEN_SEGMENT22);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  
  // Create E_ELEM_TEXT7 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT7,E_PG_MAIN,(gslc_tsRect){30,255,29,25},
    (char*)"75",0,E_SEVEN_SEGMENT18);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
