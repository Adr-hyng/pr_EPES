...
//<InitGUI !Start!>
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT2,E_PG_MAIN,(gslc_tsRect){86,15,18,24},
    (char*)"%",0,E_BUILTIN15X24);
  gslc_ElemSetTxtAlign(&m_gui,pElemRef,GSLC_ALIGN_BOT_RIGHT);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  
  // Create ContainerCap runtime modifiable text
  static char m_sDisplayText3[4] = "100";
  pElemRef = gslc_ElemCreateTxt(&m_gui,ContainerCap,E_PG_MAIN,(gslc_tsRect){29,15,54,24},
