...
void InitGUIslice_gen()
{
  ...
  // ------------------------------------------------
//<Load_Fonts !Start!>
    if (!gslc_FontSet(&m_gui,E_SEVEN_SEGMENT14,GSLC_FONTREF_PTR,&Seven_Segment14pt7b,1)) { return; }
...
//<InitGUI !Start!>
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT4,E_PG_MAIN,(gslc_tsRect){80,240,20,19},
    (char*)"o",0,E_SEVEN_SEGMENT14);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
